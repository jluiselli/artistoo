...
let config = {
	...
	conf : {
		...
		<< which: 			0, 1, 2, 3 >>
		<< fiss_rates : 	"3e-05 3.4e-05 3.7e-05 2.9e-05" >>
		<< fus_rates : 		"-0.00013 -1.6e-05 0.00012 -0.0002" >>
		<< growth_rates : 	"0.2 0.22 0.34 0.55" >>
		<< prod : 			"16 18 19 20" >>
		<< divvols : 		"4500 4500 4500 3500" >>
		<< settings : 		"0 1e-6 5e-6 1e-5" >>
		setting : <<settings.split()[which]>>,
		...
		REPLICATE_TIME: 30,
		fission_rate : <<fiss_rates.split()[which]>>,
		fusion_rate : <<fus_rates.split()[which]>>,
		rep: <<prod.split()[which]>>,
		rep2: 0,
		...
		HOST_GROWTH_MAX : 9,
		MITO_V_PER_OXPHOS : 2,
		HOST_V_PER_OXPHOS : <<growth_rates.split()[which]>>,
		...
		V : [0,502, 200],					
		host_division_volume: <<divvols.split()[which]>>,
	},
